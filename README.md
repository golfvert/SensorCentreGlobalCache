...
- the connection information to **two** Global Broker. This will determine the baseline when new Notification Messages are published
...
In the docker compose file, add the details to up to the 6 GC:
      ...
      - MQTT_GB1_BROKER=mqtts:...
      - MQTT_GB1_USERNAME=...
      - MQTT_GB1_PASSWORD=...
      - MQTT_GB2_BROKER=mqtts:...
      - MQTT_GB2_USERNAME=...
      - MQTT_GB2_PASSWORD=...
      ...
      - CACHE_DELAY_MED=300
      - CACHE_DELAY_MAX=600
      - WNM_LOGGING=true            # If present and true, this will save WNM, timestamp of reception on origin and on each cache. 10 nines means that the file was not cached.
